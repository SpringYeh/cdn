/* PrismJS 1.20.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+c+csharp+cpp+ejs+git+java+json+latex+markup-templating+php+powershell+python+ruby&plugins=line-numbers */
