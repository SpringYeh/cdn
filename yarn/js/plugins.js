    ...
    o.fn.toTop = function (t) {
        ...
        i.css({
            ...
            e.scroll(function () {
                ...
                n.autohide && ((o > n.offset && maxWidth >= 1024) ? i.fadeIn(n.speed) : i.fadeOut(n.speed));
            })
    }
    // $('.back-top').toTop();
}(jQuery);
...
/* ---------------------------------------------- /*
	* back to top (from flex-block theme)
/* ---------------------------------------------- */
window.addEventListener("DOMContentLoaded", function () {
    const backToTopFixed = document.querySelector("#bili-back-top");
    const startTop = document.body.offsetHeight;
    ...
    const toggleBackToTopBtn = (top) => {
        ...
        if (top >= startTop) {
            backToTopFixed.classList.add("active")
        } else {
            backToTopFixed.classList.remove("active")
        }
    }
